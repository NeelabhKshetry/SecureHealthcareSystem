...
namespace HealthcareSystemDesign.Controllers
{
    public class MedicalReportsController : Controller
    {
        ...
        public MedicalReportsController(healthcareContext context)
        {
            _context = context;
        }
        ...
        {
            var healthcareContext = _context.MedicalReport.Include(m => m.Medicalreport).Include(m => m.Patient);
        ...
        public async Task<IActionResult> Create([Bind("MedicalreportName,ReportFile,MedicalreportId,PatientId")] MedicalReport medicalReports)
        {
            ...
            ViewData["PatientId"] = new SelectList(_context.Patient, "PatientId", "Address", medicalReports.PatientId);
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["PatientId"] = new SelectList(_context.Patient, "PatientId", "Address", medicalReport.PatientId);
            return View(medicalReport);
        }
